                    ...
                    <div class="container-fruid pt-1">
                        <div class="row">
                            ...
                            <div class="col-10 pb-0">
                                ...
                                <!-- form -->
                                <form action="/hien/app/processing/addItemProcesser.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-select" name="city"  value="<?php echo $city?>" aria-label="Default select example" id="city">
